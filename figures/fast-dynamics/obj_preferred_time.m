...
function peak_percent = obj_preferred_time
...
for iIter = 1:4
    shift_ind = iIter;
    tmp_percent = nan(length(traj_names), 2);
...
plot([0, 5], [1/4, 1/4], 'k-', 'linew', 1)
plot([2, 2], [0 1], 'k-', 'linew', 1)
set(gcf, 'pos', [494   165   422   590]), movegui
fixPlot([2], num2str([0]'), 'Preferred time (sec)', 'Fraction of neurons')
xlim([0.5, 4.5])
ylim([0 0.35])
set(gca,'fontsize', 24)